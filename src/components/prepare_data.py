...
def prepare_data(
    ...
    if training:
        ...
        dataframe = pd.concat([dataframe, mvg5, mvg10, mvg20, mvg30, mvg60, diff_vmvg5, diff_vmvg10, diff_vmvg20, diff_vmvg30, diff_vmvg60, diff_upper_20, diff_lower_20, diff_upper_60, diff_lower_60, rsi_5, rsi_10, rsi_20, slope_5, slope_10, slope_20, slope_60, trend], axis=1)   #slope_5, slope_10, slope_20, slope_60,
    else:
        dataframe = pd.concat([dataframe, mvg5, mvg10, mvg20, mvg30, mvg60, diff_vmvg5, diff_vmvg10, diff_vmvg20, diff_vmvg30, diff_vmvg60, diff_upper_20, diff_lower_20, diff_upper_60, diff_lower_60,  rsi_5, rsi_10, rsi_20, slope_5, slope_10, slope_20, slope_60], axis=1)   #slope_5, slope_10, slope_20, slope_60
    
    allcolumns = dataframe.columns
    keepcols = ["date", "open", "high", "low", "close", "volume", 'EMA_5', 'EMA_10', 'EMA_20','EMA_30', 'EMA_60', 'trend']
    tempcols = []
    # cols = [col for col in allcolumns if col not in keepcols] 
    # dataframe[cols] = dataframe[cols].rolling(60).apply(lambda x: filter(x,50))
